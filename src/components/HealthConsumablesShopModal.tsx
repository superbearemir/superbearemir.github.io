...
export const HealthConsumablesShopModal: React.FC<HealthConsumablesShopModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[150] bg-slate-950/85 backdrop-blur-md flex items-center justify-center p-3 sm:p-5 select-none pointer-events-auto">
      <div className="bg-slate-900 border-2 border-rose-500/50 rounded-3xl w-full max-w-xl max-h-[90vh] shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-150">
        {/* Header */}
